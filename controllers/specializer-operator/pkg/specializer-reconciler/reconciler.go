...
import (
	...
	"example.com/controller-manager/controllers/specializer-operator/pkg/controllers/ipam"
	"example.com/controller-manager/controllers/specializer-operator/pkg/controllers/vlan"
	"flag"
	"fmt"
