...
import (
	"context"
	"example.com/controller-manager/controllers/edge-status-aggregator/pkg/controllers"
	"example.com/controller-manager/controllers/nephio-controller-poc/pkg/controllers/automation"
	"example.com/controller-manager/controllers/specializer-operator/pkg/controllers/config"
	"example.com/controller-manager/controllers/specializer-operator/pkg/specializer-reconciler"
...
var (
	reconcilers = map[string]Reconciler{
		"packagedeployment": &automation.PackageDeploymentReconciler{},
